  ...
  return (
    <>
       <div className='bg-white text-black pb-28 lg:pb-44 overflow-hidden'>
        {/* row 1 */}
            <div className='whitespace-nowrap animate-marquee-forward text-4xl lg:text-[7vw] font-heading font-semibold leading-[1] tracking-tight'>
            ...
            {/* row 2 */}
            <div className='whitespace-nowrap animate-marquee-reverse text-4xl lg:text-[7vw] font-heading font-semibold leading-[1] tracking-tight'>
              <span className='flex gap-4 lg:gap-8 mx-8'>
